...
class DummyData {
  ...
  static final List<FundCategory> categories = [
    ...
    FundCategory(
      ...
      categoryDescription:
          'Mixed allocation across equities, bonds and cash.',
      riskLevel: 'Medium',
      createdAt: _seedDate,
    ),
  ];
  ...
  static final List<FundManagementCompany> companies = [
    ...
    FundManagementCompany(
      ...
      companyDescription: 'Investment banking and asset management, NCBA Group.',
  ...
  static final List<Fund> funds = [
    _fund(1, 'CIC Money Market Fund', 'CICMMF', 1, 1, 2.0,
        'Flagship KES money market fund.', 'Capital preservation with competitive short-term yield.'),
    _fund(2, 'Sanlam Money Market Fund', 'SANMMF', 2, 1, 1.2,
        'Low-cost money market fund.', 'Maximise current income while preserving capital.'),
    _fund(3, 'Britam Money Market Fund', 'BRTMMF', 3, 1, 1.5,
        'Money market fund investing in short-dated paper.', 'Liquidity and stable returns.'),
    _fund(4, 'Etica Money Market Fund', 'ETCMMF', 5, 1, 1.0,
        'Digital-first money market fund.', 'High yield with daily liquidity.'),
    _fund(5, 'NCBA Fixed Income Fund', 'NCBFIF', 4, 2, 1.8,
        'Bond fund with a bias to infrastructure bonds.', 'Income generation over the medium term.'),
    _fund(6, 'Sanlam Fixed Income Fund', 'SANFIF', 2, 2, 1.5,
        'Diversified government and corporate bond fund.', 'Steady income with moderate duration risk.'),
    _fund(7, 'Britam Equity Fund', 'BRTEQF', 3, 3, 2.5,
        'Equity fund focused on NSE blue chips.', 'Long-term capital growth.'),
    _fund(8, 'CIC Equity Fund', 'CICEQF', 1, 3, 2.5,
        'Actively managed equity portfolio.', 'Outperform the NSE 20 over a market cycle.'),
    _fund(9, 'CIC Balanced Fund', 'CICBAL', 1, 4, 2.2,
        'Mixed equities, bonds and cash.', 'Balance of growth and income.'),
    _fund(10, 'NCBA Balanced Fund', 'NCBBAL', 4, 4, 2.0,
        'Multi-asset fund with tactical allocation.', 'Real returns above inflation.'),
  ];
